...
public class WebsocketClient {
    ...
    public static void main(String[] args) {
        try {
            client = new WebSocketClient(new URI("ws://localhost:8091/websocket/websocket"),new Draft_6455()) {
                @Override
        ...
        //连接成功,发送信息
//        client.onWebsocketMessage((WebSocket) SysMemory.clients.get("zhangqian"),"你好");
